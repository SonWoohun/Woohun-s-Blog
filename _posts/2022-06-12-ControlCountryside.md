...
Another thing that deserves attention is the family distribution of a village. Family distribution of a village itself does not seem fully explain the success of the development of the village. However, when jointly considered with the attitude of the leadership of the society, it does show some trends.

A village's family distribution can be divided into two categories: villages with dominant families and villages with many families. The former is called 'Dong Seong Chon' and means village whose members are connected with one or more lineage, while the latter is called 'Gak Seong Chon' and means village whose members do not share common family names. Mostly, the villages of 'Gak Seong Chon' were plebeian, while the villages of 'Dong Seong Chon' can be subdivided into aristocratic and plebeian villages. In addition, the aristocratic 'Dong Seong Chon' also has another criterion of subdividing, i.e., whether the dominant family is unique or not.

In most of the case studies, 'Dong Seong Chon' with more than two dominant families seemed to have bad outcomes in terms of the development of the rural society. The family conflict was allegedly to blame for the hardship of development. For 'Dong Seong Chon' with the unique dominant family, the success of the development was highly dependent on the leader's characteristics. When the leader was active and positive toward the policy support, the village was prone to achieve the title of 'Model Village.' On the other hand, if the leader was passive and defensive toward the intrusion of capital or the authority, the development was slow or unsuccessful.

The relationship between family distribution, leadership, and development of villages is shown in the table and the categoric branch below.

![](/assets/img/FamilyType_Leadership_Development.jpg)

![](/assets/img/FamilyType_Leadership_Development_Tree_V.jpg)

Most Model villages are from 'Gak Seong Chon' with appropriate leaders. Some aristocratic villages led by a unique dominant family became Model villages as well but accounted for a small proportion of the total.
